...
public interface IQuestionService
{
    ...
    Task<ApiResult<PagedResult<QuestionListDto>>> GetPagedAsync(QuestionListFilter filter, CancellationToken cancellationToken = default);
    ...
    Task<ApiResult<QuestionResponseDto>> ToggleStatusAsync(int id, CancellationToken cancellationToken = default);
